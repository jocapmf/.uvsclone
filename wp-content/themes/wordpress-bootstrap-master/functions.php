...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
        ...
        wp_register_style( 'rhino', get_template_directory_uri() . '/library/extensions/rhinoslider-1.05/css/rhinoslider-1.05.css', array(), '1.0', 'all' );
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
    ...
    wp_register_script(  'rhino', 
      get_template_directory_uri() . '/library/extensions/rhinoslider-1.05/js/rhinoslider-1.05.js', 
      array('jquery'), 
      '1.2' );
